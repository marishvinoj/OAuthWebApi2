...
namespace Repository
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public GenericRepository(IUnitOfWork<CustomerDbEntities> unitOfWork)
            : this(unitOfWork.Context)
        {
        }
        public GenericRepository(CustomerDbEntities context)
        {
            _isDisposed = false;
            Context = context;
        }
        public CustomerDbEntities Context { get; set; }
